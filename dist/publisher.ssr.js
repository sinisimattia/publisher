'use strict';Object.defineProperty(exports,'__esModule',{value:true});var Vue=require('vue');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var Vue__default=/*#__PURE__*/_interopDefaultLegacy(Vue);function _classCallCheck(instance, Constructor) {
...
}var index_es=/*#__PURE__*/Object.freeze({__proto__:null,ContentMatch: ContentMatch,DOMParser: DOMParser,DOMSerializer: DOMSerializer,Fragment: Fragment,Mark: Mark,MarkType: MarkType,Node: Node$1,NodeRange: NodeRange,NodeType: NodeType,ReplaceError: ReplaceError,ResolvedPos: ResolvedPos,Schema: Schema,Slice: Slice});// Mappable:: interface
...
var baseKeymap = mac$2 ? macBaseKeymap : pcBaseKeymap;// ::- Input rules are regular expressions describing a piece of text
...
}var index_es$2=/*#__PURE__*/Object.freeze({__proto__:null,CellSelection: CellSelection,TableMap: TableMap,TableView: TableView,__clipCells: clipCells,__insertCells: insertCells,__pastedCells: pastedCells,addColSpan: addColSpan,addColumn: addColumn,addColumnAfter: addColumnAfter,addColumnBefore: addColumnBefore,addRow: addRow,addRowAfter: addRowAfter,addRowBefore: addRowBefore,cellAround: cellAround,colCount: colCount,columnIsHeader: columnIsHeader,columnResizing: columnResizing,columnResizingPluginKey: key$1$1,deleteColumn: deleteColumn,deleteRow: deleteRow,deleteTable: deleteTable,findCell: findCell,fixTables: fixTables,fixTablesKey: fixTablesKey,goToNextCell: goToNextCell,handlePaste: handlePaste,inSameTable: inSameTable,isInTable: isInTable,mergeCells: mergeCells,moveCellForward: moveCellForward,nextCell: nextCell,pointsAtCell: pointsAtCell,removeColSpan: removeColSpan,removeColumn: removeColumn,removeRow: removeRow,rowIsHeader: rowIsHeader,selectedRect: selectedRect,selectionCell: selectionCell,setAttr: setAttr,setCellAttr: setCellAttr,splitCell: splitCell,splitCellWithType: splitCellWithType,tableEditing: tableEditing,tableEditingKey: key$1,tableNodeTypes: tableNodeTypes,tableNodes: tableNodes,toggleHeader: toggleHeader,toggleHeaderCell: toggleHeaderCell,toggleHeaderColumn: toggleHeaderColumn,toggleHeaderRow: toggleHeaderRow,updateColumnsOnResize: updateColumns});var dist = createCommonjsModule(function (module, exports) {
...
var dist_66 = dist.removeNodeBefore;function _defineProperty$1(obj, key, value) {
  if (key in obj) {
    Object.defineProperty(obj, key, {
      value: value,
      enumerable: true,
...
function nodeIsActive(state, type) {
  ...
  return node.node.hasMarkup(type, _objectSpread2$1(_objectSpread2$1({}, node.node.attrs), attrs));
...
class ComponentView {
  ...
  createDOM() {
    const Component = Vue__default['default'].extend(this.component);
    const props = {
      editor: this.editor,
      node: this.node,
      view: this.view,
...
var highlight = HLJS({});var format = createCommonjsModule(function (module) {
(function() {
...
function noop() {}var collabKey = new PluginKey("collab");var GOOD_LEAF_SIZE = 200;
...
var Append = /*@__PURE__*/(function (RopeSequence) {
  ...
  return Append;
}(RopeSequence));var historyKey = new PluginKey("history");
var closeHistoryKey = new PluginKey("closeHistory");class Blockquote extends Node$2 {
  get name() {
    return 'blockquote';
  }
...
var script = {
  ...
  methods: {
    ...
    linkPrompt: function linkPrompt(command) {
...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm.editable ? _vm._ssrNode("<div data-v-3a575c86>", "</div>", [_c('editor-menu-bubble', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(ref) {
        ...
        return [_c('div', {
          ...
          on: {
            "click": function click($event) {
              return _vm.linkPrompt(commands.image);
            }
          }
          ...
          on: {
            "click": function click($event) {
              return _vm.linkPrompt(commands.iframe);
            }
          }
        }, [_vm._t("embed", [_c('span', [_vm._v("</>")])])], 2)])])];
      }
    }], null, true)
  })], 2) : _vm._e(), _vm._ssrNode(" "), _c('editor-content', {
    staticClass: "content",
    attrs: {
      "editor": _vm.editor
    }
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-3a575c86_0", {
    source: ".editor[data-v-3a575c86]{position:relative}.menububble[data-v-3a575c86]{position:absolute;z-index:20;transform:translateX(-50%);visibility:hidden;opacity:0}.menububble.is-active[data-v-3a575c86]{opacity:1;visibility:visible}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-3a575c86";
/* module identifier */

var __vue_module_identifier__ = "data-v-3a575c86";
/* functional template */
...
var __vue_module_identifier__$1 = "data-v-75e94a16";
/* functional template */
...
var __vue_module_identifier__$2 = "data-v-6486613f";
/* functional template */
